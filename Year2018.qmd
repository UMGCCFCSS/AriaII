...
```{r}
The2018 <- Data |> dplyr::filter(year(DateTime) == 2018)
```

## {.sidebar}
Dashboard contains historical data from **2018** for the **BDFACS Aria II**.
...
Filename <- paste0("Historical_AriaII_2018")
...
CSVname <- paste0("Historical_AriaII_2018.csv")
