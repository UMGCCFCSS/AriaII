...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2017.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2019.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2021.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2023.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='https://umgccfcss.github.io/InstrumentQC/data/Canto/Archive/HolisticDataAria.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2018.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2020.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2022.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_AriaII_2024.csv'>Gain and MFI</a></li>
</ul>
")
```
